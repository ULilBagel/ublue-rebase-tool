...
class CommandExecutor:
    ...
    def _validate_image_url(self, image_url: str) -> Tuple[bool, Optional[str]]:
        ...
        if stripped_url.startswith("ostree-unverified-registry:"):
            stripped_url = stripped_url[len("ostree-unverified-registry:"):]
        elif stripped_url.startswith("ostree-image-signed:docker://"):
            stripped_url = stripped_url[len("ostree-image-signed:docker://"):]
        elif stripped_url.startswith("ostree-remote-registry:"):
            stripped_url = stripped_url[len("ostree-remote-registry:"):]
        ...
        allowed_registries = {
            ...
            "quay.io/fedora/": {
                "name": "Fedora Quay",
                "allowed_paths": ["fedora-silverblue", "fedora-kinoite"],
                "require_tag": True
            },
        ...
        for registry, config in allowed_registries.items():
            if stripped_url.startswith(registry):
        ...
        path_after_registry = stripped_url[len(matching_registry):]
