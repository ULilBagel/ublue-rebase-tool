# ublue-rebase-tool - Task 11

Execute task 11 for the ublue-rebase-tool specification.

## Task Description
Update sidebar for execution mode

## Code Reuse
**Leverage existing code**: src/ublue-image-manager.py:create
...
```
/spec-execute 11 ublue-rebase-tool
```
...
2. Execute task 11: "Update sidebar for execution mode"
