# ublue-rebase-tool - Task 6

Execute task 6 for the ublue-rebase-tool specification.

## Task Description
Update WebKit JavaScript bridge for new operations

## Code Reuse
**Leverage existing code**: src/ublue-image-manager.py:inject
...
```
/spec-execute 6 ublue-rebase-tool
```
...
2. Execute task 6: "Update WebKit JavaScript bridge for new operations"
